...
CRITERIA_EXTRACTOR_SYSTEM = (
    ...
    "CV'de aranacak kısa Türkçe ve İngilizce eşdeğer terimleri evidenceHints olarak "
    "üret; yalnız Türkçe cümleler yazma. Örn. 'temiz kod' için 'temiz kod', 'Clean "
    "Code', 'code review'; 'uzaktan çalışma' için 'uzaktan çalışma', 'remote', 'fully "
    "remote'. Bunlar yeni kriter değil, aynı kriterin kaynak CV'de geçebilecek "
    "ifadeleri olsun. "
    "Kullanıcının yazmadığı bir kriteri "
...
CRITERIA_INTENT_SYSTEM = (
    ...
    "kopyalanmış kesintisiz label, kısa description ve aynı kriterin CV'de geçebilecek "
    "kısa Türkçe ve İngilizce eşdeğer terimlerini içeren evidenceHints üret; yalnız "
    "Türkçe cümleler yazma (örn. 'temiz kod' için 'Clean Code', 'uzaktan çalışma' için "
    "'remote'). Label'a 'göre "
