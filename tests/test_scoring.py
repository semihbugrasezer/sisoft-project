...
def test_compute_average_rounds_to_two_decimals():
    scores = [
        CriterionScore(criterionId="a", criterionLabel="A", score=95, reason="x"),
        CriterionScore(criterionId="b", criterionLabel="B", score=85, reason="x"),
        CriterionScore(criterionId="c", criterionLabel="C", score=90, reason="x"),
    ]
...
def test_dynamic_scores_dict_maps_label_to_score():
    scores = [CriterionScore(criterionId="a", criterionLabel="React", score=70, reason="x")]
